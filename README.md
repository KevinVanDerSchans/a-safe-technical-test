...
- [Index](#index)
  ...
  - [Unit Testing with Jest](#unit-testing-with-jest)
    - [Test Reports with jest-stare](#test-reports-with-jest-stare)
  - [End-to-End Testing with Cypress](#end-to-end-testing-with-cypress)
    - [Test Reports with Mochawesome](#test-reports-with-mochawesome)
...
To open [Jest](https://jestjs.io/) and run all tests in watch mode with a coverage report:

```sh
  npm run test:prod
```

For automated testing environment (CI/CD pipelines), run:

```sh
  npm run test:ci
```

#### Test Reports with jest-stare

After running tests in headless mode, you can view detailed test reports generated by
[jest-stare](https://www.npmjs.com/package/jest-stare):

1. Locate the report at the following path in the root of the project:

```sh
  ./jest-stare/index.html
```

2. Open the `index.html` file in any web browser to view a detailed, interactive report of the test results.

<br>

## End-to-End Testing with Cypress

To open [Cypress](https://www.cypress.io/) in interactive mode and execute tests, use the following command:

```sh
  npm run cypress
```

For automated testing in a headless environment (CI/CD pipelines), run:
...
```sh
  ./testing/cypress-reports/mochawesome.html
```

2. Open the `mochawesome.html` file in any web browser to view a detailed, interactive report of the test results.
...
| `/dashboard`            | Main dashboard for logged-in users. Provides an overview and quick access to features. |
| `/dashboard/statistics` | Statistics for logged-in users.                                                        |
| `/dashboard/customers`  | Customers data for logged-in users.                                                    |
| `/dashboard/users`      | Users data for logged-in users.                                                        |
...
| Route                                        | Description                    |
| -------------------------------------------- | ------------------------------ |
| `https://jsonplaceholder.typicode.com/posts` | Retrieves a list of posts.     |
| `https://jsonplaceholder.typicode.com/users` | Retrieves a list of users.     |
| `https://randomuser.me/api/customers`        | Retrieves a list of customers. |

### Authentication Routes

| Route            | Description                                                                        |
| ---------------- | ---------------------------------------------------------------------------------- |
| `/auth/signin`   | NextAuth's default sign-in page. Allows users to log in using supported providers. |
| `/auth/signout`  | For signing out users and clearing sessions.                                       |
| `/auth/callback` | Callback route used by NextAuth to handle authentication responses from providers. |
...
<div align="center">
  <br>
    ...
    <br>
    <br>
    <a href="https://www.jenkins.io/" target="_blank" rel="noreferrer"> <img src="public/readme/svgs/jenkins.svg" alt="Jenkins" width="60" height="60" style="margin-right: 24px"/></a>
    ...
    <a href="https://jestjs.io/" target="_blank" rel="noreferrer"> <img src="public/readme/svgs/jest.svg" alt="Jest" width="60" height="60" style="margin-right: 24px"/></a>
    <br>
    <br>
  <br>
</div>
